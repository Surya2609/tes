...
def execute(filters=None):
    ...
    columns = [
        {"label": "Sales Order", "fieldname": "sales_order", "fieldtype": "Link", "options": "Sales Order", "width": 190},
        ...
        {"label": "Customer Name", "fieldname": "customer_name", "fieldtype": "Data", "width": 110},
    ...
    SELECT
        ...
        CONCAT(
            ...
            IFNULL((
                ...
                WHERE b.item_code = soi.item_code AND b.actual_qty > 0
            ), ''), '" ',
